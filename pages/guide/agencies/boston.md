...
Catenary is a transit app that helps you see where your bus or train is, anywhere in Boston and its suburbs.  
...
* **MBTA subway** trains (including Green Line) are supported
  * Realtime train positions, predicted arrival times, and alerts are supported
* **Mattapan Trolley** is supported
  * Realtime train positions, predicted arrival times, and alerts are supported
* **MBTA Commuter Rail** trains are supported
  * Realtime train positions, predicted arrival times, and alerts are supported

### Bus

* **MBTA buses** are supported
  * Realtime bus positions, predicted arrival times, and alerts are supported
* **MassPort Logan Express** buses are supported
  * No realtime data is available

### Ferry

* **MBTA ferries** are supported
  * Realtime ferry positions, predicted arrival times, and alerts are supported
* **Provincetown Fast Ferry** is supported
  * No realtime data is available

## Frequently asked questions

### Does Catenary show real-time data in Boston?
Yes. Catenary provides live train and bus locations and estimated departure times in Boston. Some small operators are not supported; see the notes above.

### Does Catenary show service alerts in Boston?

We show service alerts for the MBTA. 
...
* [Rapid transit and frequent bus routes](https://cdn.mbta.com/sites/default/files/2025-08/2025-08-25-subway-map.pdf)
* [Commuter Rail](https://cdn.mbta.com/sites/default/files/2025-03/2025-03-24-commuter-rail-map-v.42f.pdf)
* [More official maps](https://www.mbta.com/maps)
...
* [Boston (CTA)](https://discord.com/channels/1148092048625385552/1442386621281337344)

Things we want to work on for Boston:

* [ ] Track numbers for Commuter Rail
