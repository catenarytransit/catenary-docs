...
The cities are numbered by the [size of their urban area](https://en.wikipedia.org/wiki/List_of_largest_cities).
...
* [63] [Houston](houston.md)  
* [67] [Miami](miami.md)  
* [70] [Philadelphia](philadelphia.md)  
* [72] [Atlanta](atlanta.md)  
...
* [28] Istanbul is **not supported**.  
* [29] Tehran is **not supported**.  
* [57] Riyadh is **not supported**.  
* [66] Baghdad is **not supported**.  

## North Africa

* [14] Cairo is **not supported**.  
* [54] Khartoum is **not supported**.  
* [76] Alexandria is **not supported**.  

## Subsaharan Africa

* [22] Lagos is **not supported**.  
* [27] Johannesburg is **not supported**.  
* [30] Kinshasa is **not supported**.  
* [47] Luanda is **not supported**.  
* [53] Dar es Salaam is **not supported**.  

## East Asia

Please note that mainland China, Taiwan, South Korea, and North Korea are not supported.
...
* [3] Delhi is **not supported**.  
* [5] Mumbai (Bombay) is **not supported**.  
* [11] Kolkata (Calcutta) is **not supported**.  
* [15] Karachi is **not supported**.  
* [16] Dhaka is **not supported**.  
* [23] Bengaluru (Bangalore) is **not supported**.  
* [33] Chennai (Madras) is **not supported**.  
* [35] Lahore is **not supported**.  
* [40] Hyderabad is **not supported**.  
* [50] Pune is **not supported**.  
* [51] Ahmedabad is **not supported**.  
* [62] Surat is **not supported**.  

## Oceania

None of the 81 largest cities are in Oceania; we'll add the list of supported cities in Oceania later.
