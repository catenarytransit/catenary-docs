...
Catenary is a transit app that helps you see where your bus or train is, anywhere in Kuala Lumpur, Putrajaya, and the Klang Valley.  
Watch live departures and explore nearby stops — all from one place.
...
* **Keretapi Tanah Melayu Berhad** intercity and commuter trains are included
  * This includes:
    * Line 1 Batu Caves–Pulau Sebang (Seremban Line)
    * Line 2 Tanjung Malim–Port Klang
  * Realtime train locations are supported
  * Service alerts and train arrival estimates are not available
* **Prasarana Rapid Rail** trains are supported
  * This includes:
    * LRT Line 3 Ampang
    * LRT Line 4 Sri Petaling
    * LRT Line 5 Kelana Jaya
    * Line 8 Monorail
    * MRT Line 9 Kajang
...
* **Prasarana Rapid Bus** buses are supported
  * Realtime train locations are supported
  * Service alerts and train arrival estimates are not available

## Not supported

* **Express Rail Link Sdn Bhd** trains are not supported
  * This includes:
    * Line 6 KLIA Ekspres
    * Line 7 KLIA Transit
* Private bus operators are not supported

## Frequently asked questions

### Does Catenary show real-time data in the Klang Valley?
Yes. Catenary provides live train locations and estimated departure times in the Klang Valley.

We also provide live bus locations in the the Klang Valley suburbs, but unfortunately CTA does not provide live bus locations in a format we can use.

### Does Catenary show service alerts in the Klang Valley?
...
* [Klang Valley](https://discord.com/channels/1148092048625385552/1437332273107308638)

Things we want to work on for the Klang Valley:

* [ ] Provide data for Express Rail Link Sdn Bhd
* [ ] The Malaysian government plans to release more data soon; we should add the data to our service promptly
